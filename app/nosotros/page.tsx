      ...
      <section className="mt-12 grid gap-8 lg:grid-cols-[1.3fr_minmax(0,1fr)] items-start">
        ...
        <div className="card-surface p-6">
          ...
          <ul className="mt-4 space-y-3 text-sm text-slate-300">
            <li>
              <strong className="text-slate-100">Simple primero.</strong>{" "}
              Menos capas, menos fricción, más claridad para el usuario.
            </li>
            <li>
              <strong className="text-slate-100">Tecnología comprensible.</strong>{" "}
            ...
            <li>
              <strong className="text-slate-100">Operación continua.</strong>{" "}
