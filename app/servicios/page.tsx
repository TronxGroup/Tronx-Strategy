...
export const metadata = {
  ...
  description:
    "Entregables en semanas: embudos completos, performance marketing, CRM y automatizaciones. Programa Socios y Tronx Cloud Suite.",
};
    ...
    <Section className="py-16">
      ...
      <div className="max-w-3xl">
        ...
        <p className="p-muted mt-4">
          Entregables en semanas: diseñamos y operamos tu embudo con
          sitios/landings, performance marketing, CRM y automatizaciones.
          Destacamos nuestro{" "}
          <a
            href="/servicios/programa-socios"
            className="font-semibold underline decoration-brand-500 underline-offset-2"
          >
            Programa Socios (Revenue Share)
          </a>{" "}
          y la plataforma unificada{" "}
          <a
            href="/servicios/tronx-cloud"
            className="font-semibold underline decoration-brand-500 underline-offset-2"
          >
            Tronx Cloud Suite
          </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          <div className="lg:col-span-2">
            ...
            <h2 className="text-xl font-bold text-slate-900 mt-1">
              Vendemos tus servicios. Tú entregas. Nosotros captamos, nutrimos y
              cerramos.
            </h2>
            <p className="text-sm text-slate-700 mt-2 max-w-3xl">
              Pagas sólo por performance (porcentaje sobre venta válida).
              Operamos con activos de conversión, CRM y contenidos.
            </p>
            ...
            <ul className="mt-4 text-sm text-slate-700 space-y-2">
              <li className="inline-flex items-start gap-2">
                ...
                <span>
                  <strong>Activos de conversión</strong>: video comercial,
                  landing y copy de oferta.
                </span>
              </li>
              <li className="inline-flex items-start gap-2">
                <CheckCircle2 size={18} className="text-brand-600 mt-0.5" />
                <span>
                  <strong>CRM & automatización</strong>: Zoho (o HubSpot),
                  scoring, pipelines, secuencias y nurturing.
                </span>
              </li>
              <li className="inline-flex items-start gap-2">
                <CheckCircle2 size={18} className="text-brand-600 mt-0.5" />
                <span>
                  <strong>Base B2B segmentada</strong> (opt-out y compliance) +
                  campañas cuando aplica.
                </span>
              </li>
              <li className="inline-flex items-start gap-2">
                <CheckCircle2 size={18} className="text-brand-600 mt-0.5" />
                <span>
                  <strong>Cierre & reporting</strong>: registro en CRM y
                  liquidación mensual con reporte validado.
                </span>
              </li>
            </ul>
          ...
          <div className="card p-5 bg-white border border-brand-200 rounded-2xl">
            ...
            <a
              href="/servicios/programa-socios#requisitos"
      ...
      <div className="mt-12 card p-6 border border-slate-200 rounded-2xl bg-gradient-to-br from-brand-50 to-white">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-1">
          Tu operación digital unificada (WebOps, Data, CRM, Ads, Security)
          administrada por Tronx Strategy.
        </h2>
        <p className="text-sm text-slate-700 mt-2 max-w-3xl">
          Infraestructura web, datos & analítica, CRM & automatizaciones, Ads y
          seguridad — integrado, medible y escalable.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <FeatureCard title="WebOps">
            Dominios, DNS, SSL (Cloudflare), hosting serverless (Vercel) y
            CI/CD desde GitHub.
          </FeatureCard>
          <FeatureCard title="Data & Analytics">
            GA4, Tag Manager y Search Console. Eventos, conversiones y
            dashboards CAC/CVR/LTV.
          </FeatureCard>
          <FeatureCard title="CRM & Automation">
            Zoho CRM (o HubSpot), scoring, pipelines, nurturing, formularios
            etiquetados y auto-respuestas.
          </FeatureCard>
          <FeatureCard title="Ads Ops">
            Google / Meta / LinkedIn Ads conectados a CRM. UTM, atribución 30
            días y ROAS.
          </FeatureCard>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a href="/servicios/tronx-cloud" className="btn btn-secondary">
            Ver detalle de Tronx Cloud Suite
          </a>
          <a href="/contacto" className="btn btn-ghost">
            Solicitar demo
          </a>
      ...
      <div className="mt-12">
        ...
        <p className="p-muted mt-2 max-w-3xl">
          Implementamos la base, operamos el crecimiento y acompañamos con
          estrategia aplicable.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <FeatureCard title="Onboarding (2–4 semanas)">
            Setup de dominios, correo corporativo, CRM, landings y medición con
            GA4/GTM. Handoff documentado.
          </FeatureCard>
          <FeatureCard title="Growth Retainers">
            Sprints quincenales: Ads (Google/Meta/LinkedIn), SEO/CRO,
            contenidos, dashboards y reporting.
          </FeatureCard>
          <FeatureCard title="Estrategia & Capacitaciones">
            Planes estratégicos 6–18 meses, playbooks comerciales y workshops
            para tu equipo.
          </FeatureCard>
        </div>
      </div>
      ...
      <div className="card p-6 mt-12 border border-slate-200 rounded-2xl bg-white">
        <h4 className="font-semibold text-slate-900">
          ¿Listo para acelerar captación y cerrar con métricas claras?
        </h4>
        <p className="text-sm text-slate-700 mt-2">
          Si tu oferta calza, partimos con <strong>Programa Socios</strong>. Si
          necesitas base tecnológica sólida, activamos{" "}
          <strong>Tronx Cloud Suite</strong> y tus{" "}
          <strong>Servicios Core</strong>.
        </p>
