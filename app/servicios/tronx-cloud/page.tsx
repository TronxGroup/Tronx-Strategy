    ...
    <Section className="py-16">
      ...
      <div className="max-w-3xl">
        ...
        <h1 className="mt-3 text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900">
          Tronx <span className="text-emerald-600">Cloud Suite</span>
        </h1>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card title="Ads Ops">
          <ul className="list-disc pl-5 space-y-1">
            <li>Google / Meta / LinkedIn Ads conectados a CRM</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card title="Integraciones nativas">
          <p>Zoho CRM, HubSpot (si aplica), Google Workspace, GA4, GTM, Search Console, Vercel, Cloudflare, Make/Zapier.</p>
        </Card>
        <Card title="Operación centralizada">
          <p>
